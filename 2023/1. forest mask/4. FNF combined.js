...
//print('2017-2021 fnfCombo',fnfCombo);
...
Map.addLayer(fnfCombo2000to2021,{},"fnfCombo2000to2021")
...
// Map.addLayer(fnfComboLong.select('fnf2000'), pal, '1985-2021 FNF Combo '+studyEndYear, false);
...
//print(outStringLong);
Map.addLayer(fnfCombo,{},"fnfCombo")
...
Map.addLayer(fnfComboLong,{},"fnfComboLong")
Export.image.toAsset({
  image: fnfComboLong, 
