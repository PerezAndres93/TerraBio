...
var undesignated = gp.layers.farmsUndesignated;
...
var samzParams = gp.params.samzHigh_jorge;// for loss (Jorge)
var runVersion = samzParams.runVersion;
var runParams = samzParams.runParams;

var samzParams2 = gp.params.samzNeutral_jorge; // for gain (Jorge)
...
var changeParamsGain = samzParams2.changeParamsGain; 
...
var metadataGain = {
  ...
  RunParams_maxSegments: runParams2.maxSegments,
  RunParams_spikeThreshold: runParams2.spikeThreshold,
  RunParams_vertexCountOvershoot: runParams2.vertexCountOvershoot,
  RunParams_preventOneYearRecovery: runParams2.preventOneYearRecovery,
  RunParams_recoveryThreshold: runParams2.recoveryThreshold,
  RunParams_pvalThreshold: runParams2.pvalThreshold,
  RunParams_bestModelProportion: runParams2.bestModelProportion,
  RunParams_minObservationsNeeded: runParams2.minObservationsNeeded  ,
};
...
var outlineIntv = empty.paint({
 ...
 Map.addLayer(outlineIntv, {palette: paletteCiat.colors.colorReference}, 'Reference', false); //yellow CIAT

//refernece
var outlineIntv = empty.paint({
 featureCollection: undesignated,
 color: 1,
 width: 2
});
 Map.addLayer(outlineIntv, {palette: paletteCiat.colors.colorUndesignated}, 'Undesignated', false); //yellow CIAT
