...
Map.addLayer(outlineRegen, {palette: paletteCiat.colors.colorRegeneration}, 'Regeneration'); //orange CIAT
...
Map.addLayer(outlineUndesignated, {palette: paletteCiat.colors.colorFarm}, 'Undesignated'); 
...
print('Farm boundaries: area ha', farms.geometry().area({maxError: 1000, proj:'EPSG:3857'}).divide(10000));
print('Interventions - ALL: area ha', interventions.geometry().area({maxError: 1000, proj:'EPSG:3857'}).divide(10000));
print('Reference forest: area ha', convertPolygon(reference).area({maxError: 1000, proj:'EPSG:3857'}).divide(10000));
print('Counterfactuals: area ha', convertPolygon(counterfactuals).area({maxError: 1000, proj:'EPSG:3857'}).divide(10000));
print('Farm undesignated: area ha', farmsUndesignated.geometry().area({maxError: 1000, proj:'EPSG:3857'}).divide(10000));
print('AOI: area ha', aoi.geometry().area({maxError: 1000, proj:'EPSG:3857'}));
