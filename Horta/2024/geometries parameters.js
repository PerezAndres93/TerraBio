...
var trainingForest = ee.FeatureCollection(
   'users/ingperezescobar/TerraBio/Horta/data/2023/ForestMasks/training_forest_2022');

var trainingNonForest = ee.FeatureCollection(
...
var gain = ee.Image( 
  'users/ingperezescobar/TerraBio/Horta/outputs/2024/lt_gain_newest_2017_2023_SAMZguidance_Neutral_v4');
var loss = ee.Image(
  'users/ingperezescobar/TerraBio/Horta/outputs/2024/lt_loss_comboMask_newest_2017_2023_SAMZguidance_Neutral_v4');
...
exports.layers = {
  ...
  nicfi2020: nicfi2020,
  //training polygons
  trainingForest: trainingForest, 
  trainingNonForest: trainingNonForest,
  landtrendr: {
     loss: loss,
     gain: gain,
...
var studyStartYear = studyEndYear - 6; //original data 5 edited by Jorge


//start and end years for long FNF mask creation
var nicfiStartYear = 2017;
...
var samzNeutral = { // MODIFICADO POR JORGE
  runVersion: 'Neutral_v4',
  runParams: { 
    maxSegments:            8, //7
    spikeThreshold:         1, //0.9
    vertexCountOvershoot:   3,
    preventOneYearRecovery: false,
    recoveryThreshold:      1,// 0.8
  ...
  changeParamsLoss: {
    ...
    sort:   'newest',
    year:   {checked:true, start: studyStartYear, end: studyEndYear},
    mag:    {checked:true, value:265,  operator:'>'},//230
...
// These are values that SERVIR uses for a neutral threshold
// Note: Most likely using neutral settings
var samzNeutral_jorge_gain = {
  runVersion: 'Neutral_v4',
  runParams: { 
    maxSegments:            8,// 8 GAIN
    spikeThreshold:         0.6,// 0.8 GAIN
    vertexCountOvershoot:   3,
    preventOneYearRecovery: true,
    recoveryThreshold:      0.5,//0.5
    pvalThreshold:          0.05,//
    bestModelProportion:    0.75,//
    minObservationsNeeded:  6},
  //Params same as loss, except for delta.
  ...
  changeParamsGain: {
    ...
    sort:   'newest',
    year:   {checked:true, start: studyStartYear, end: studyEndYear},
    mag:    {checked:true, value:70,  operator:'>'},//
...
var samzHigh = {
  ...
  changeParamsGain: {
    ...
    mag:    {checked:true, value:200,  operator:'>'},
    dur:    {checked:false, value:4,    operator:'<'},
    preval: {checked:false, value:3,  operator:'>'},
    mmu:    {checked:false, value:6}},
};
...
var samzHigh_jorge = {
  ...
  changeParamsLoss: {
    delta:  'loss',
    sort:   'newest',
    year:   {checked:true, start: studyStartYear + 1, end: studyEndYear},
    mag:    {checked:true, value:200,  operator:'>'},
    dur:    {checked:false, value:4,    operator:'<'},
    preval: {checked:false, value:500,  operator:'>'},
    mmu:    {checked:false, value:6}},
  ...
  changeParamsGain: {
    ...
    preval: {checked:false, value:200,  operator:'>'},
    mmu:    {checked:false, value:6}},
};
...
exports.params = {
  ...
  samzNeutral_jorge_gain: samzNeutral_jorge_gain,
  //samzNeutral_jorge_loss: samzNeutral_jorge_loss,
  samzHigh: samzHigh,
  samzHigh_jorge: samzHigh_jorge,
