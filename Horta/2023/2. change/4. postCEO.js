...
//var pc = require('users/dnekorchuk/terrabio:horta/2023/pixelCountReadable');
...
//###################################################
var aoi = 'd_FarmInterventionReference_Initial_Loss' //filename tag for which set of points are included, referencing aoi and any desification points that are included or not
var folder = '00_TerraBio'
var exportdate = '_09_25' //filename tag of date and or version number
...
//var ceoRaw = gp.layers.ceo_filter_a //Intervention_Initial_AditionGain
//var ceoRaw = gp.layers.ceo_filter_b //FarmReference_Initial_Loss
//var ceoRaw = gp.layers.ceo_filter_c //FarmInterventionReference_Initial_Gain
var ceoRaw = gp.layers.ceo_filter_d //FarmInterventionReference_Initial_Loss
//var ceoRaw = Horta23_allpoints_v2;
//print(ceoRaw,'ceoRaw')
var ceo = ceoRaw.distinct('sampleid');
...
var dictionaryLossCeo = ee.Dictionary({
        0: 'null',
        1: 'stable forest 2017-2022',
        2: 'Degradation of forest',
        3: 'Deforestation',
        4: 'non forest 2017-2022',
...
var dictionaryGainCeo = ee.Dictionary({
      0: 'No Canopy Cover Gain 2017-2022',
      1: 'Canopy Cover Gain (LULC change) 2017-2022'
    });
