...
var addlPoints = addlPoints.merge(moreCounterfactualPoints);
...
var folder = 'pixelCounts_TerraBio_CafeApui_2022'
...
Export.table.toDrive({
  ...
  //"system:index" and ".geo" are not allowed in the CEO csv upload. 
  selectors: fieldsExport, 
  fileNamePrefix: dealName + '_' + reportYear + '_allSamplePoints_forCEO_seed' + ptSeed + '_2023xxxx', 
