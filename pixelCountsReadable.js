//Adapted copy of dsaah/SIG-EE/CEO function for pixel counting, 
// to be used in TerraBio work by external colleagues. 
...
function getStatsSingleBand(
  ...
  region = region || statsImg.geometry().bounds(); //image.geometry().bounds();
  scale = scale || 30;
  crs = crs || 'EPSG:4326';
